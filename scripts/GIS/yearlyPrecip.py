...
def main(argv):
    ...
    for i in range(len(hrapi)):
        key = hrapi[i]
        shp.point(1, 2)  # bogus
        shp.record(ohrap[key]['rain'], ohrap[key]['hours'],
                   ohrap[key]['mrain'],  ohrap[key]['jan_tot'],
                   ohrap[key]['feb_tot'], ohrap[key]['mar_tot'],
                   ohrap[key]['apr_tot'],  ohrap[key]['may_tot'],
                   ohrap[key]['jun_tot'], ohrap[key]['jul_tot'],
                   ohrap[key]['aug_tot'], ohrap[key]['sep_tot'],
                   ohrap[key]['oct_tot'],  ohrap[key]['nov_tot'],
                   ohrap[key]['dec_tot'])
