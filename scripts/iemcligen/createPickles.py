...
cl["NW"] = mydb.query(
    "SELECT * from climate_sectors WHERE sector = 1"
).dictresult()
cl["NC"] = mydb.query(
    "SELECT * from climate_sectors WHERE sector = 2"
).dictresult()
cl["NE"] = mydb.query(
    "SELECT * from climate_sectors WHERE sector = 3"
).dictresult()
cl["WC"] = mydb.query(
    "SELECT * from climate_sectors WHERE sector = 4"
).dictresult()
cl["C"] = mydb.query(
    "SELECT * from climate_sectors WHERE sector = 5"
).dictresult()
cl["EC"] = mydb.query(
    "SELECT * from climate_sectors WHERE sector = 6"
).dictresult()
cl["SW"] = mydb.query(
    "SELECT * from climate_sectors WHERE sector = 7"
).dictresult()
cl["SC"] = mydb.query(
    "SELECT * from climate_sectors WHERE sector = 8"
).dictresult()
cl["SE"] = mydb.query(
    "SELECT * from climate_sectors WHERE sector = 9"
).dictresult()
