...
$mo_ramps = Array(
	...
	1 => Array(0.5, 1, 2, 3, 4, 6, 8, 10,11,12,13),
	2 => Array(0.25, 0.5, 0.75, 1, 1.5, 2, 2.5, 3, 3.5,4,5),
	3 => Array(10, 50, 100, 150, 200, 250, 300, 350, 300, 400, 500),
	4 => Array(4, 8, 12, 16, 20, 25, 30, 35,36,37,38),
	5 => Array(5, 10, 20, 40, 60, 100, 120, 160,161,162,163),
...
$yr_ramps = Array(
	...
	1 => Array(0.5, 1, 2, 3, 4, 6, 8, 10,12,14,16),
	2 => Array(1, 2, 4, 6, 8, 10, 12, 20,30,50,100),
	3 => Array(100, 200, 300, 400, 500, 750, 1000, 1250,1500,2000,2500),
	4 => Array(4, 8, 12, 16, 20, 25, 30, 35,40,50,75),
	5 => Array(5, 10, 20, 40, 60, 100, 120, 160,200,240,280),
	6 => Array(10, 25, 50, 75, 100, 150, 200, 250,300,350,400),
	7 => Array(100, 200, 300, 400, 500, 600, 800, 1000,1200,1500,2000),
	8 => Array(1, 4, 8, 16, 24, 28, 32, 36, 40, 44, 48),
    9 => Array(150, 200, 250, 300, 350, 400,450,500,550,600,650),   // TSW
    10 => Array(-20, -12, -8, -4, -2, 0, 2, 4, 8, 12,20),
    11 => Array(10, 15, 20, 24, 27, 30, 33, 36, 40, 45, 50),
    12 => Array(-30, -20, -15, -10, -5, 0, 5, 10, 15, 20,30),
	13 => Array(0.5, 1, 2, 4, 8, 12, 16, 24,36,48,60), // Metric Loss
);
...
"runoff_ratio" => Array('dbstr' => 'avg_runoff / (avg_precip+0.01) * 100',
  ...
  'title' => "Total Runoff/Precip Ratio: ",
...
"min_loss_acre" => Array('dbstr' => 'min_loss * 4.463','dbcol' => 'min_loss',
  ...
  'title' => "Minimum Daily Soil Erosion: ",
  'table' => $resultsTBL, 'myramp' => 0,
  'maplayer' => 'daily_rainfall', 'gtype' => 'twp',
  'dbdate' => strftime("%Y-%m-%d", $ts) ),
...
"avg_loss_acre" => Array('dbstr' => 'avg_loss * 4.463','dbcol' => 'avg_loss',
  'units' => 'tons per acre', 'cramp' => $c,'dbagg'=> 'sum',
  'title' => "Average Total Soil Erosion: ",
  'table' => $resultsTBL, 'myramp' => 0,
  'maplayer' => 'daily_rainfall', 'gtype' => 'twp',
  'dbdate' => strftime("%Y-%m-%d", $ts) ),
...
"max_loss_acre" => Array('dbstr' => 'max_loss * 4.463','dbcol' => 'max_loss',
  'units' => 'tons per acre', 'cramp' => $c,'dbagg'=> 'sum',
  'title' => "Maximum Daily Soil Erosion: ",
  'table' => $resultsTBL, 'myramp' => 0,
  'maplayer' => 'daily_rainfall', 'gtype' => 'twp',
  'dbdate' => strftime("%Y-%m-%d", $ts) ),
...
"ve_runoff_in" => Array('dbstr' => 've_runoff / 25.4','dbcol' => 've_runoff',
  'units' => 'inches', 'cramp' => $c,'dbagg'=> 'sum',
  'title' => "Variance Estimator for Total Runoff: ",
  'table' => $resultsTBL, 'myramp' => 0,
  'maplayer' => 'daily_rainfall', 'gtype' => 'twp',
  'dbdate' => strftime("%Y-%m-%d", $ts) ),
...
"ve_loss_acre" => Array('dbstr' => 've_loss * 4.463','dbcol' => 've_loss',
  'units' => 'tons per acre', 'cramp' => $c, 'dbagg'=> 'sum',
  'title' => "Variance Estimator for Total Erosion: ",
  'table' => $resultsTBL, 'myramp' => 0,
  'maplayer' => 'daily_rainfall', 'gtype' => 'twp',
  'dbdate' => strftime("%Y-%m-%d", $ts) ),
...
$c0s->outlinecolor->setRGB($colors[0]['r'], $colors[0]['g'], $colors[0]['b']);
...
$c1s->outlinecolor->setRGB($colors[1]['r'], $colors[1]['g'], $colors[1]['b']);
...
$c2s->outlinecolor->setRGB($colors[2]['r'], $colors[2]['g'], $colors[2]['b']);
...
$c3s->outlinecolor->setRGB($colors[3]['r'], $colors[3]['g'], $colors[3]['b']);
...
$c4s->outlinecolor->setRGB($colors[4]['r'], $colors[4]['g'], $colors[4]['b']);
...
$c5s->outlinecolor->setRGB($colors[5]['r'], $colors[5]['g'], $colors[5]['b']);
...
$c6s->outlinecolor->setRGB($colors[6]['r'], $colors[6]['g'], $colors[6]['b']);
...
$c7s->outlinecolor->setRGB($colors[7]['r'], $colors[7]['g'], $colors[7]['b']);
...
$c8s->outlinecolor->setRGB($colors[8]['r'], $colors[8]['g'], $colors[8]['b']);
...
$c9s->outlinecolor->setRGB($colors[9]['r'], $colors[9]['g'], $colors[9]['b']);
...
$c10s->outlinecolor->setRGB($colors[10]['r'], $colors[10]['g'], $colors[10]['b']);
...
$c11s->outlinecolor->setRGB($colors[11]['r'], $colors[11]['g'], $colors[11]['b']);
